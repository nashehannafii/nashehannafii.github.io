...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "News",
          description: "Latest updates, conference presentations, and academic milestones.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Publications",
          description: "A curated list of my research publications—journal articles, conference papers, and books—generated from my bibliography.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Projects",
          description: "My collection of works.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=g-D2WqoAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
